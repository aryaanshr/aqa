# In the AttemptPuzzle method of the Puzzle class, I added a print statement to display the number of symbols left to place
# The line self.__SymbolsLeft -= 1 was already present in the AttemptPuzzle method, which decrements the counter after a symbol is pleaced
...
class Puzzle():
    ...
    def AttemptPuzzle(self):
        ...
        while not Finished:
            ...
            print(f"Symbols left to place: {self.__SymbolsLeft}")
            Row = -1
            Valid = False
            while not Valid:
                try:
