# I added a check using os.path.exists to see if the file entered by the user exists.
# If the file does not exist, a message is displayed to the user indicating the situation: File not found. Starting a standard puzzle instead.. Then, the default game is started.
# If the file exists, the game is loaded from that file.
# If the user just presses Enter without providing a filename, the default game is started, as per the original behavior.
    ...
    while Again == "y":
        ...
        if len(Filename) > 0:
            if os.path.exists(Filename + ".txt"):
                ...
                print("File not found. Starting a standard puzzle instead.")
